        ...
        <nav className={styles.navbar}>
            ...
            >
                <ul className={styles.navLinks}>
                    ...
                    <Link onClick={() => setToggle(false)} className={styles.navLink} href="/api/Articals">Articles</Link>
                    <Link onClick={() => setToggle(false)} className={styles.navLink} href="/abou">About</Link>
                   {isAdmin && (
