...
import { AERTICAL_PAGE } from "@/app/utels/const";
import { Article } from "@prisma/client";
import Link from "next/link";
import { getArticles } from "@/apicalls/articleApiCall";
import Pagination from "@/app/componenets/articles/Pagination";
...
const AdminArticlesTable = async ({ searchParams: { pageNumber } }: AdminArticlesTableProps) => {
  ...
  const count: number = await prism.article.count();
  const pages = Math.ceil(count / AERTICAL_PAGE);
